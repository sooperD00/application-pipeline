...
| created_at | datetime | |
| auth_token_expires_at | datetime, nullable | not set yet — the beta cookie carries a 30-day max-age instead. [s-26220f-b] moves expiry into an `auth_tokens` table at the same 30 days and drops this column; [s-26220f-c] makes it slide on use. The older "7 days for anonymous" intent does not survive that: it was written for a world where anonymous data expired *because* there was nothing to convert into. See remaining-sprints.md, [s-26220f] |
