...
| created_at | datetime | |
| auth_token_expires_at | datetime, nullable | not set yet — the beta cookie carries a 30-day max-age instead. 7 days for anonymous is the intent once accounts exist to convert into; the two get reconciled when auth lands |
